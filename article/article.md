...
### SVG Elements
There are a few basic elements that can be rendered, you could create a circle, arc, rectangle, text element, label, button or draw a path. This time we will focus on rendering a rectangle that will be used to create a snake body. 
